 ...
 * under the License.
 */
package com.yuntu.doc2h5.internal;
...
public class HttpUtils {
	...
	public static HttpResponse doGet(String host, String path, String method,
		...
		return sendGetRequest(httpClient, request, 10);
	}

	private static HttpResponse sendGetRequest(HttpClient httpClient,
			HttpGet request, int retryTimes) throws IOException {
		...
		try {
			...
			if (retryTimes > 0) {
				...
				return sendGetRequest(httpClient, request, --retryTimes);
			} else {
				throw e;
			}
		}
